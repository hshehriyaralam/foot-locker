...
const CheckOutCart = ({navigation}:any) => {
  return (
    <div className="w-full min-h-[300px]   border  font-maven  p-3   flex flex-col gap-2">
      ...
      >
        <Image src={PaypalText} alt="paypalText" className="w-20" />
        Checkout
      </Button>
      ...
      <div className="p-1 text-gray-700 uppercase font-semibold text-xs  mt-2">
        ...
        <div className="flex items-center gap-x-3 mt-2 ">
          <Image src={PayFour} alt="pay-one" className="w-10" />

          <Image src={PayTwo} alt="pay-one" className="w-10" />

          <Image src={PayThre} alt="pay-one" className="w-10" />

          <Image src={PayOne} alt="pay-one" className="w-10" />
        </div>
      </div>
    </div>
  );
